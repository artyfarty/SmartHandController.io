...
void UI::init(const char version[], const int pin[7], const int active[7], const int SerialBaud, const OLED model) {
  ...
  delay(500);
  if (model == OLED_SH1106) display = new U8G2_EXT_SH1106_128X64_NONAME_1_HW_I2C(DISPLAY_ROTATION); else
  if (model == OLED_SH1106_4W_SW_SPI) display = new U8G2_EXT_SH1106_128X64_NONAME_1_4W_SW_SPI(DISPLAY_ROTATION); else
  if (model == OLED_SH1106_4W_HW_SPI) display = new U8G2_EXT_SH1106_128X64_NONAME_1_4W_HW_SPI(DISPLAY_ROTATION);
  if (model == OLED_SSD1306) display = new U8G2_EXT_SSD1306_128X64_NONAME_F_HW_I2C(DISPLAY_ROTATION); else
  if (model == OLED_SSD1309) display = new U8G2_EXT_SSD1309_128X64_NONAME_F_HW_I2C(DISPLAY_ROTATION); else
  if (model == OLED_SSD1309_4W_SW_SPI) display = new U8G2_EXT_SSD1309_128X64_NONAME_F_4W_SW_SPI(DISPLAY_ROTATION); else
